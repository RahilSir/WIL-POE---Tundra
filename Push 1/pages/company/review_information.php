...
<!-- Header -->
  <div class="form-container">
    ...
    <div class="header" style="display:flex; align-items:center; justify-content:center; gap:15px;  margin-bottom:20px;">
        <img src="../../assets/images/logo.jpg"  style="height:50px; margin-top:40px">
...
<p><strong>Similair Reg:</strong> <?= htmlspecialchars($name['similar_reg']) ?></p>
  ...
  <form action="companyStatus.php" method="POST">
    <button type="submit">✅ Confirm & Submit Application</button>
  </form>
</div>
