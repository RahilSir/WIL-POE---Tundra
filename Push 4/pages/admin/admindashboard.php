...
.hero {
  background: url("../../assets/images/cpt.jpg") no-repeat center center;
...
<body>
 ...
 <header class="header">
  <div class="container">
   <div class="brand">
  <img src="../../assets/images/logo.jpg" alt="Tundra Logo" class="logo-img">
  <h1 class="logo-text">Tundra Tax & Accounting</h1>
    ...
    <nav>
      ...
      <!-- Dropdown Menu -->
      <div class="dropdown">
        <a href="../public/services.html" class="dropbtn">Services ▾</a>
        <div class="dropdown-content">
          <a href="../public/services.html">Services</a>
          <a href="../public/bookkeeping.html">Bookkeeping</a>
          <a href="../public/tax-services.html">Tax Services</a>
        </div>
      </div>
