...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $rules = [
        ...
        'idNum' => ['required', 'idNumber'],
        'streetAddress' => ['required', 'minLength' => 5, 'maxLength' => 200],
    ...
    if (Validator::validateForm($_POST, $rules)) {
        ...
        try {
            ...
            if (!$stmtApp) {
                throw new Exception("Database prepare failed for applications table");
            }
            ...
            if (!$stmt) {
                throw new Exception("Database prepare failed for contact info table");
            }
